...
import edu.wpi.first.wpilibj.templates.commands.ReadLM;
...
public class OI {
    ...
    boolean highConvForward = false;
    boolean lowConvForward = false;
    double speed = 0;
    ...
    public OI() {
        ...
        {
            armb3.whenPressed(new ConveyorLowReverse());
            lowConvForward = false;
        }
        if (!highConvForward)
        {
            armb4.whenPressed(new ConveyorHighReverse());
            highConvForward = true;
        }
        else
        {
            armb5.whenPressed(new ConveyorHighOn());
            highConvForward = false;
        }*/
        ...
        SmartDashboard.putBoolean("LowConvForward", lowConvForward);
        SmartDashboard.putBoolean("highConvForward", highConvForward);
        /*SmartDashboard.putData("armbutton8", armb8);
        SmartDashboard.putData("armbutton1", armb1);
        SmartDashboard.putData("armbutton6", armb6);
        SmartDashboard.putData("armbutton7", armb7);
        SmartDashboard.putData("armbutton10", armb10);
        SmartDashboard.putData("armbutton11", armb11);*/
