...
public class Elevator extends PIDSubsystem {
	...
	public static final double BOTTOM = 804;
	public static final double STAGING_HEIGHT = BOTTOM + 100;
	public static final double ONE_TOTE_HIGH = BOTTOM + 300;
	public static final double TWO_TOTE_HIGH = ONE_TOTE_HIGH + 300;
	public static final double TOP = BOTTOM + 1300;
	...
	public void incrementSetpoint() {
		...
		while (setpointArray[loop] <= potentiometer.get() && loop < setpointArray.length - 1){
			loop++;
		}
	...
	public void decrementSetpoint() {
		int loop = currentSetpointIndex;
		// We decrement to the next lowest from the current position
		while (setpointArray[loop] >= potentiometer.get() && loop > 0){
			loop--;
		}
		currentSetpointIndex = loop;
		setSetpoint(setpointArray[currentSetpointIndex]);
