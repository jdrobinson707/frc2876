...
import org.usfirst.frc2876.FRC2876AerialAssault.commands.CollectAndRaise;
import org.usfirst.frc2876.FRC2876AerialAssault.commands.LowerArm;
import org.usfirst.frc2876.FRC2876AerialAssault.commands.MoveToScorePosition;
import org.usfirst.frc2876.FRC2876AerialAssault.commands.RaiseArm;
import org.usfirst.frc2876.FRC2876AerialAssault.commands.ReleaseBall;
...
public class XboxController {
    ...
    public XboxController(int port) {
        ...
        lTrigger = new JoystickButton(m_pad, L_TRIGGER_VAL);
        rTrigger = new JoystickButton(m_pad, R_TRIGGER_VAL);
    //public Button dLeft = new JoystickButton (m_pad, DPAD_LR);

        Y.whenPressed(new RaiseArm());
        A.whenPressed(new LowerArm());
        X.whenPressed(new MoveToScorePosition());
        B.whenPressed(new MoveToScorePosition());
        //lBumper.whenPressed(new CollectBall());
        lBumper.whenPressed(new CollectAndRaise());
        rBumper.whenPressed(new ReleaseBall());
    }
