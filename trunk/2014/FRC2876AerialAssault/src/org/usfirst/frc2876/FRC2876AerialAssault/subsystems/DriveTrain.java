...
public class DriveTrain extends Subsystem {
    ...
    Ultrasonic leftSonar = RobotMap.driveTrainleftSonar;
    Ultrasonic rightSonar = RobotMap.driveTrainrightSonar;
    Ultrasonic frontSonar = RobotMap.driveTrainfrontSonar;
    ...
    private class GyroPID {
        ...
        private static final double gyroKf = 0.000;
