...
public class Drive extends Command {
    ...
    protected void execute() {
        ...
        if (Robot.driveTrain.isDriveGain()) {
            Robot.driveTrain.arcadeDriveGain(-Robot.oi.getXboxLeftY(), -Robot.oi.getXboxRightX());
        } else {
            Robot.driveTrain.arcadeDrive(-Robot.oi.getXboxLeftY() * .8, -Robot.oi.getXboxRightX() * .8);
            //Robot.driveTrain.arcadeDrive(-Robot.oi.getXboxLeftY(), -Robot.oi.getXboxRightX());
        }
