...
public class Shooter extends Subsystem {
    ...
    DigitalInput feederlm = RobotMap.FEEDER_LM;
    PIDController sc;
    ...
    final double LOW_LIMIT = 2.852;
    final double HIGH_LIMIT = 2.986;
    ...
    public void potInit() {
        sc = new PIDController(.01, 0, 0, ac, new PIDOutput() {
            public void pidWrite(double output) {
                shootingAngleJaguar.set(output);
            }
        });
        sc.setPercentTolerance(5.0);
        sc.setOutputRange(-.5, .5);
    ...
    public void startFeeder(){
        feederRelay.set(Relay.Value.kOn);
    }
