...
public class RobotMap {
	...
	LiveWindow.addActuator("Shooter", "ShootingAngle Jaguar", SHOOTER_SHOOTINGANGLE_JAGUAR);
        
        DRIVETRAIN_GYRO = new Gyro(1, 2);
	LiveWindow.addSensor("DriveTrain", "Gyro", DRIVETRAIN_GYRO);
        DRIVETRAIN_GYRO.setSensitivity(0.007);
        
//        driveTrainleftEncoder = new Encoder(1, 2, true, CounterBase.EncodingType.k4X);
...
//        LiveWindow.addSensor("DriveTrain", "leftEnc", driveTrainleftEncoder);
        ...
        DRIVETRAIN_LEFTENCODER = new Encoder(1, 2, true, CounterBase.EncodingType.k4X);
	LiveWindow.addSensor("DriveTrain", "leftEncoder", DRIVETRAIN_LEFTENCODER);
        ...
        DRIVETRAIN_RIGHTENCODER = new Encoder(3, 4, false, CounterBase.EncodingType.k4X);
