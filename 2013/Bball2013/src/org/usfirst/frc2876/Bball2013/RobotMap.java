...
public class RobotMap {
    ...
    public static void init() {
        ...
        conveyorHighlmMiddle = new DigitalInput(2, 5);
        LiveWindow.addSensor("ConveyorHigh", "lmMiddle", conveyorHighlmMiddle);

        conveyorHighconveyorHighRelay = new Relay(2, 7);
        ...
        conveyorLowconveyorLowRelay = new Relay(2, 3);
        ...
        driveTrainleftEncoder = new Encoder(3, 4, false, CounterBase.EncodingType.k4X);
        ...
        driveTrainrightEncoder = new Encoder(1, 2, false, CounterBase.EncodingType.k4X);
