...
public class Target {
    ...
    /**
     * Search for a target in the given image of a color range given and
    ...
    public String toString() {
        double x = ((int)(getXPosition() * 100))/100.00;
        double y = ((int)(getYPosition() * 100))/100.00;
        double s = ((int)(getSize() * 100))/100.00;
        return "Target at ( " + x + " , " + y + " ) of size " + s;
